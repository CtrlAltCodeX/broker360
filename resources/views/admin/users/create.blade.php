            ...
            <form action="{{ route('admin.users.store') }}" method="post" enctype="multipart/form-data"> <!--begin::Body-->
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="website" name="permissions[website]">
                        <label for="website" class="form-check-label">Website</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="publish_property" name="permissions[publish_property]">
                        <label for="publish_properties" class="form-check-label">Publish Properties</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="information" name="permissions[real_estate]">
